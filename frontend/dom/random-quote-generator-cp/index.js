...
function displayQuote() {
  // TODO: answer here
  rand = getQuote();
  document.getElementById("random-quote").innerHTML = quotes[rand].quote;
  document.getElementsByClassName("author")[0].innerHTML = quotes[rand].author;
  document.getElementsByClassName("citation")[0].innerHTML =
    typeof quotes[rand].citation == "undefined" ? "" : quotes[rand].citation;
  document.getElementsByClassName("year")[0].innerHTML =
    typeof quotes[rand].year == "undefined" ? "" : quotes[rand].year;
